...
function enablePinchZoom(pdfViewer) {
    ...
    const reset = () => {
        ...
        pinchScale = 1;
        if (PDFViewerApplication.pdfViewer.currentScale < 0.43)
            PDFViewerApplication.pdfViewer.currentScale = 0.43;
        else if (PDFViewerApplication.pdfViewer.currentScale > 20)
            PDFViewerApplication.pdfViewer.currentScale = 20;     
    };
